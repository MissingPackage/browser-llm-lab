...
| 4 | **Chiusura** — **done (it.11)** | checklist del DONE WHEN del contratto voce per voce con evidenza; HANDOFF §1 aggiornato; triage del docket; il goal successivo (TEMPO AL PRIMO TOKEN) ereditata la lista di ciò che è stato escluso coi numeri | diretto | none | `docs/**`, `HANDOFF.md`, `.harness/goals/**` | ready |
