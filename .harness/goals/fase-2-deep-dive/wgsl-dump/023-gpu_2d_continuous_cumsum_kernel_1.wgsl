//----------------------------------------
// Function: gpu_2d_continuous_cumsum_kernel_1
//----------------------------------------
...
fn gpu_2d_continuous_cumsum_kernel_1(
  ...
  let tx_idx : i32 = (((v__1 * 512i) + (i32(threadIdx.y) * 128i)) + (i32(threadIdx.x) * 4i));
  for (var i_s : i32 = 0i; i_s < 4i; i_s++) {
  ...
  let idx : i32 = ((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i));
  workgroupBarrier();
  ...
  let idx_1 : i32 = ((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i));
  workgroupBarrier();
  ...
  let idx_2 : i32 = ((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i));
  workgroupBarrier();
  ...
  let idx_3 : i32 = ((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i));
  workgroupBarrier();
  ...
  let idx_4 : i32 = ((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i));
  workgroupBarrier();
  ...
  if (i32(threadIdx.y) == 0i) {
    let idx_5 : i32 = ((i32(threadIdx.x) * 4i) + 128i);
  ...
  workgroupBarrier();
  if (i32(threadIdx.y) == 0i) {
    let idx_6 : i32 = ((i32(threadIdx.x) * 4i) + 256i);
  ...
  workgroupBarrier();
  if (i32(threadIdx.y) == 0i) {
    let idx_7 : i32 = ((i32(threadIdx.x) * 4i) + 384i);
  ...
  let idx_8 : vec4<i32> = vec4<i32>((((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i)))+(1i*0), (((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i)))+(1i*1), (((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i)))+(1i*2), (((i32(threadIdx.y) * 128i) + (i32(threadIdx.x) * 4i)))+(1i*3));
  workgroupBarrier();
  for (var i_s_1 : i32 = 0i; i_s_1 < 4i; i_s_1++) {
