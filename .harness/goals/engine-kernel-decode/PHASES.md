...
- riga 0 — **GATE**, non muove la metrica: decide se le leve esistono prima di
  ...
  **ESITO it.1**: le leve esistono. Attenzione 33,7x (`split`: softmax in
  streaming + vec4 + contesto su 16 workgroup), GEMV q4_0 4,0x
  (`vec4-rows2-sg`). 16 enunciati pre-registrati su 17 confermati; P5 confermato
  ⇒ l'ordine 1→2 resta. Memo:
  `docs/deep-dive/kernel-decode-fase0-memo-2026-08-13.md`.
