...
accodati nello stesso command encoder e flushati in ~7 submit per token (misurati,
`results/dispatch-profile/` — copie e free forzano flush intermedi) + una sync per token
