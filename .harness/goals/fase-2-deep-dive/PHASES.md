...
| 4 | Doc `dequant-kernels.md` | stessi check meccanici della fase 2 sul file `dequant-kernels.md` | none | `docs/deep-dive/dequant-kernels.md` | ready (dump WGSL fatto, iterazione 4: 34 kernel reali in `wgsl-dump/`; resta il doc) |
| 5 | Doc `kv-cache-layout.md` | stessi check meccanici della fase 2 sul file `kv-cache-layout.md` | none | `docs/deep-dive/kv-cache-layout.md` | ready |
