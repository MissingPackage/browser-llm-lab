...
| 2 | Slab pre-impacchettati q35 (**obiettivo centrato it.8, lettera al docket item 5**) | il repack K-quant esce dal path on-miss (import-time, come GLM `expertSlab`): micro-bench del costo/miss PRIMA e DOPO nello stesso JSON, delta riportato; ktest MoE q35 PASS invariati | none | src/engine/**, tests/**, scripts/** | **done (docket 5)** |
