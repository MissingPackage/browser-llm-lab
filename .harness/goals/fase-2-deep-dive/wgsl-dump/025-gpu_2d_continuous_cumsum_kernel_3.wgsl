//----------------------------------------
// Function: gpu_2d_continuous_cumsum_kernel_3
//----------------------------------------
...
fn gpu_2d_continuous_cumsum_kernel_3(
  ...
  for (var i : i32 = 0i; i < 4i; i++) {
    let idx : i32 = ((((v__1 * 512i) + (i32(threadIdx.y) * 128i)) + (i * 32i)) + i32(threadIdx.x));
